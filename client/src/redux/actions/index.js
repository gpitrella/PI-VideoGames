...
export function searchGames(name, rating, genre){
    return function(dispatch){
        return axios.get('/videogame?name=' + name + '&rating=' + rating + '&genre=' + genre)
                        .then(games => {
...
// export function searchGames(nameGame, rating, genre){
//     return async function(dispatch){
//         var json = await axios.get('http://localhost:3001/videogame?name=' + nameGame + '&rating=' + rating + '&order=' + genre)
